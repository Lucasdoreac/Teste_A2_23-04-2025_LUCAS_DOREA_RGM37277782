...
**Resposta: c) É uma estrutura de dados onde os elementos são organizados linearmente.**
...
**Resposta: a) Verificar se a estrutura está vazia.**
...
**Resposta: c) Matrizes podem representar dados com mais de uma dimensão.**
